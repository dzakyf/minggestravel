        ...
        <div class="banner_inner d-flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <div class="page_link">
                        <a href="{{url('/')}}">Home</a>
                        <a href="{{('/artikel/id_artikel')}}">Detail Artikel</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <center><img class="img-fluid" src="{{$artikel->gambar}}" style="width: 50%" alt=""></center>
                            </div>
                        </div>
                        <div class="col-lg-3  col-md-3">
                            <div class="blog_info text-right">
                                <div class="post_tag">
                                    <a class="active" href="#">{{$artikel->kategori}}</a>
                                </div>
