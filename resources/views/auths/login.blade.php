...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{URL::asset('extadmin/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Login untuk masuk he halaman admin</p>
...
<!-- AdminLTE App -->
<script src="{{URL::asset('extadmin/dist/js/adminlte.min.js')}}"></script>
