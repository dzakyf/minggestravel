    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col mb-2 text-right">
          <a href="{{ url('/admin/kepustakaan/download/create') }}">
                <button class="btn btn-primary" type="button">Tambah Download</button>
          </a>
        </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="badge badge-info" href="{{url('/admin/kepustakaan/download/')}}/{{$download->id_download}}">
                      detail
                    </a>
                  </td>
                </tr>
