    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col mb-2 text-right">
          <a href="{{ url('/admin/kepustakaan/perpustakaan/create') }}">
                <button class="btn btn-primary" type="button">Tambah Perpustakaan</button>
          </a>
        </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$perpustakaan->kategori}}</td>
                  <td>
                    <a class="badge badge-info" href="{{url('/admin/kepustakaan/perpustakaan/')}}/{{$perpustakaan->id_perpustakaan}}">
                      detail
                    </a>
                  </td>
                </tr>
