      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Form Tambah Mitra</h3>
          </div>
          <!-- /.card-header -->
          <form method="post" action="{{ url('/admin/mitra') }}" enctype="multipart/form-data">
          @csrf
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" style="width: 100%;" name="nama" id="nama" placeholder="Masukkan nama mitra" value="{{old('nama')}}">
