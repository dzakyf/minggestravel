    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form method="post" action="{{ url('/admin/profile/visidanmisi/visi') }}/{{$visi->id_visi}}">
          @method('patch')
          @csrf
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <textarea name="visi" id="visi" class="textarea form-control @error('visi') is-invalid @enderror" placeholder="Masukkan visi Event" 
