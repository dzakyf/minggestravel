    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form method="post" action="{{ url('/admin/profile/visidanmisi/visi') }}" >
          @csrf
            <div class="card-body">
              <div class="row">
                <div class="col">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <textarea name="visi" id="visi" class="textarea form-control @error('visi') is-invalid @enderror" placeholder="Masukkan visi" value="{{old('visi')}}"
                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{old('visi')}}</textarea>
