...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Kompetensi SDM</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Home</a></li>
              <li class="breadcrumb-item active">Kompetensi SDM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col mb-2 text-right">
          <a href="{{ url('/admin/profile/kompetensisdm/create') }}">
                <button class="btn btn-primary" type="button">Tambah Kompetensi SDM</button>
          </a>
        </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Kompetensi SDM</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
