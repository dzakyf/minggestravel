          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                @csrf
                  <div class="form-group">
                    <textarea name="jawaban" id="jawaban" class="textarea2 form-control @error('jawaban') is-invalid @enderror" placeholder="Masukkan jawaban" 
                            style="width: 100%; color: black; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$layananaduan->jawaban}}
                    </textarea>
              ...
              <div class="col mb-2 text-center">
                <a href="{{url('/admin/layananaduan/')}}/{{$layananaduan->id_layananaduan}}" class="btn btn-primary">Batal Edit</a>
              </div>
